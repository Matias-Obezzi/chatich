...
export const Marquee = ({
  ...
  return (
    <div className="w-full h-auto relative" ref={wrapperRef}>
      <svg
        width="100%"
        height="100%"
      ...
      <div className="absolute w-full h-full top-0 left-0 pointer-events-none [&>*]:pointer-events-none" ref={marqueeContainerRef}>
